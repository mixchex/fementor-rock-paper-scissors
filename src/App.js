...
function App() {
  ...
  const [score, setScore] = useState(
    localStorage.getItem("rps_score")
      ? parseInt(localStorage.getItem("rps_score"))
      : 0
  );
    ...
    <div className="px-7 sm:px-9">
      <div className="w-full h-screen flex flex-col justify-between mx-auto max-w-700 py-7 sm:py-9">
        ...
        <Footer
          type={type}
          onReset={handleReset}
          onShowRules={() => setModalVisible(true)}
        />
        <Modal
        ...
        >
          <img
            ...
            alt={`Rules for Rock, Paper, Scissors${
              type != "standard" && ", Lizard Spock"
            }`}
          />
        </Modal>
      </div>
